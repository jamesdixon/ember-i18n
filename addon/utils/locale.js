...
export default class Locale {
  ...
  _setConfig() {
    ...
    if (this.rtl === undefined) {
      Ember.warn(`ember-i18n: No RTL configuration found for ${this.id}.`, this.rtl === undefined, { id: 'ember-i18n.locale-lacks-rtl' });
      this.rtl = defaultConfig.rtl;
    }

    if (this.pluralForm === undefined) {
      Ember.warn(`ember-i18n: No pluralForm configuration found for ${this.id}.`, this.pluralForm === undefined, { id: 'ember-i18n.locale-lacks-pluralForm' });
